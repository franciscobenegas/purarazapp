...
export function DataTablePotrero({ data }: DataTableProps) {
  ...
  const [deletingPotrero, setDeletingPotrero] = useState<Potrero | null>(null);
  ...
  const handleDeleteConfirm = async () => {
    if (deletingPotrero) {
      ...
      try {
        const resp = await fetch(`/api/potrero/${deletingPotrero.id}`, {
          method: "DELETE",
          headers: {
        ...
        return (
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              <Link href={`/configuracion/potrero/${row.original.id}`}>
                <DropdownMenuItem>
              ...
              <DropdownMenuItem
                onClick={() => setDeletingPotrero(row.original)}
              >
  ...
  return (
    <div className="p-4 bg-background shadow-md rounded-lg mt-4">
      ...
      <div className="rounded-md border">
        ...
        <Dialog
          open={!!deletingPotrero}
          onOpenChange={() => setDeletingPotrero(null)}
        >
          <DialogContent>
            <DialogHeader>
            ...
            <DialogFooter className="gap-2 sm:space-x-0">
              <DialogClose>
                <Button
                  variant="outline"
                  onClick={() => setDeletingPotrero(null)}
                >
                  Cancelar
                </Button>
              </DialogClose>
