...
export function DataTable({ data }: DataTableProps) {
  ...
  const [deletingEstancia, setDeletingEstancia] = useState<Estancia | null>(
    null
  );
  ...
  const handleDeleteConfirm = async () => {
    ...
    if (deletingEstancia) {
      ...
      try {
        const resp = await fetch(`/api/estancia/${deletingEstancia.id}`, {
          method: "DELETE",
          headers: {
  ...
  const columns: ColumnDef<Estancia>[] = [
    {
      accessorKey: "nombre",
      header: ({ column }) => {
        return (
        ...
        return (
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem
                onClick={() => setDeletingEstancia(row.original)}
              >
  ...
  return (
    <div className="p-4 bg-background shadow-md rounded-lg mt-4">
      ...
      <div className="rounded-md border">
        ...
        <Dialog
          open={!!deletingEstancia}
          onOpenChange={() => setDeletingEstancia(null)}
        >
          <DialogContent>
            <DialogHeader>
            ...
            <DialogFooter className="gap-2 sm:space-x-0">
              <DialogClose>
                <Button
                  variant="outline"
                  onClick={() => setDeletingEstancia(null)}
                >
                  Cancelar
                </Button>
              </DialogClose>
