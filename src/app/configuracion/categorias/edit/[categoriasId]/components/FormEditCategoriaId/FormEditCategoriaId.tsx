...
export function FormEditCategoriaId(props: FormProops) {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    const updateCategoria = {
      ...
      sexo: values.sexo,
      edad: values.edad,
      promedioKilos: values.promedioKilos,
      precioVentaCabeza: values.precioVentaCabeza,
      precioVentaKilo: values.precioVentaKilo,
      precioCostoCabeza: values.precioCostoCabeza,
      precioCostoKilo: values.precioCostoKilo,
    };
    ...
    <div className=" mx-auto py-4 px-4 max-w-4xl">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Complete el formulario para editar la categoría de ganado.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
